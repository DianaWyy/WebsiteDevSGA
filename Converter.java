...
public class Converter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("celsiusToFahrenheit: " + celsiusToFahrenheit(25));
        System.out.println("printFahrenheitConversionTable:");
        printFahrenheitConversionTable(32, 35);
        System.out.println("printCelsiusConversionTable:");
        printCelsiusConversionTable(32, 35);
        System.out.println("celsiusWarmer (38 , 98) : " + celsiusWarmer(38 , 98));
        System.out.println("fahrenheitWarmer (100 , 37) : " + fahrenheitWarmer(100 , 37));
    ...
    public static void printFahrenheitConversionTable(int lower, int upper) {
        for (int i = lower; i <= upper; i++) {
            System.out.printf("Fahrenheit: " + i + " -> Celsius: %.3f %n", fahrenheitToCelsius(i));
        }
    }
    ...
    public static void printCelsiusConversionTable(int lower, int upper) {
        int i = lower;
        while (i <= upper) {
            System.out.printf("Celsius: " + i + " -> Fahrenheit: %.3f %n", celsiusToFahrenheit(i));
            i++;
        }
    }
    ...
    public static boolean celsiusWarmer(int celsius, int fahrenheit) {
        if (celsiusToFahrenheit(celsius) > fahrenheit) {
            return true;
        }
        return false;
    }
    ...
    public static boolean fahrenheitWarmer(int fahrenheit, int celsius) {
        boolean value = (fahrenheitToCelsius(fahrenheit) > celsius) ? true : false;
        return value;
    }
}
